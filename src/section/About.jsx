        ...
        >
          ...
          <div className="flex-1 flex flex-col justify-center text-center md:text-left">
            ...
            <p className="mt-2 text-lg sm:text-xl text-white/90 font-semibold">
              Final-Year CSE (AI & ML) Student • Full Stack Developer • AI Enthusiast
            </p>

            <p className="mt-4 text-gray-300 leading-relaxed text-base sm:text-lg max-w-2xl md:max-w-3xl">
             I'm Hema Rani, a final-year CSE (AI & ML) student passionate about Full-Stack Development and Artificial Intelligence. I build modern web applications, explore machine learning solutions, and enjoy solving real-world problems through technology. With experience in MERN Stack, Python, AI/ML, and DSA, I'm focused on creating impactful products while continuously learning and growing as a developer.
            </p>
            {/* Quick stats */}
        ...
        <div className="grid md:grid-cols-1">
          ...
          >
            ...
            <p className="text-gray-300 leading-relaxed text-base sm:text-lg">
             I am a passionate Computer Science student specializing in Artificial Intelligence and Machine Learning. I enjoy building modern web applications, exploring AI-powered solutions, and solving real-world problems through technology.
            </p>
            <p className="mt-4 text-gray-400 text-base sm:text-lg">
              My expertise includes MERN Stack Development, Python, Machine Learning, and Data Structures & Algorithms. I love participating in hackathons, building innovative projects, and continuously learning emerging technologies.
            </p>
            <p className=" mt-4 italic text-gray-300 text-lg">
               "Passionate about leveraging AI and software engineering to create impactful digital experiences." 
            </p>
          </motion.div>
        </div>
      </div>
